...
/**
 * ---------------------------------------------------------------------------
 * NewFinancialYear.jsx — "Create a financial year" page
 * ---------------------------------------------------------------------------
 * Route it like: <Route path="/financial-years/new" element={<NewFinancialYear />} />
 *
 * Fills the gap Home.jsx already assumes exists: it calls
 * navigate('/financial-years/new') when a school has no financial years yet.
 *
 * Data flow:
 ...
 *  - On success: navigate straight to /financial-years/:id (the new year's
 *    detail page), so the principal can start on the trial balance.
 *
 * Reuses the same class names (hk-*, fy-*) as Home.jsx / financial-year.jsx
 * so it inherits your existing stylesheet. A few new classes (nfy-*) are
 * introduced for the form itself — see new-financial-year.css.
 * ---------------------------------------------------------------------------
 */
